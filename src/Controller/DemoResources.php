...
use Marlinc\PassbookBundle\GoogleWallet\WalletObjects\Models\Barcode;
...
class DemoResources
{
    ...
    public static function makeLoyaltyClassResource(string $classId): LoyaltyClass
    {
    ...
    public static function makeLoyaltyObjectResource(string $classId, string $objectId): LoyaltyObject
    {
        $barcode = new Barcode();
